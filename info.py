...
PICS_URL = (environ.get('PICS', 'http://ibb.co/23V2JSGM')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003757252744")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-100")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'http://ibb.co/xtn45092')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'aravind72888@oksbi')    # Owner UPI ID for payments
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/Akpremimum_bot")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Akpremimum_bot")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Akpremimum_bot")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/telugutigersgroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AKMOVIESSTELUGU') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/AKMOVIESSTELUGU') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'AKOFFICIAL))
MULTI_CLIENT = False
name = str(environ.get('name', 'AKOfficial))
